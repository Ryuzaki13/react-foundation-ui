...
/**
 * Управляемый полноэкранный viewer поверх Yet Another React Lightbox.
 * Компонент изолирует внешний API, сохраняет безопасный для SSR первый render и принимает тот же
 * независимый от хранилища responsive-контракт, что ImageView. Визуальные настройки публикуются только как `--image-viewer-*`.
 */
