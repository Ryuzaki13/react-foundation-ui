...
| `resolveTrigger` | `(eventTarget: EventTarget \| null) => HTMLElement \| null` | —            | Только `ContextMenu.Trigger`: выбирает вложенную цель события или отменяет открытие через `null` |
