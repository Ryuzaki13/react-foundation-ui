...
import { OptionMultiSelect, type OptionMultiSelectProps } from "../OptionMultiSelect";
...
const meta = {
	title: "UI/OptionMultiSelect",
	component: OptionMultiSelect<DepartmentOption>,
	args: {
		label: "Подразделения",
...
} satisfies Meta<typeof OptionMultiSelect<DepartmentOption>>;
...
export const IndependentIdentity: Story = {
	...
	render: function Render(args) {
		const [, updateArgs] = useArgs<OptionMultiSelectProps<DepartmentOption>>();
