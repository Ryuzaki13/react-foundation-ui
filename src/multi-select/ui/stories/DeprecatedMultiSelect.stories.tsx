...
const meta = {
	title: "UI/DeprecatedMultiSelect",
	component: DeprecatedMultiSelect,
	args: {
		label: "Города",
...
} satisfies Meta<typeof DeprecatedMultiSelect>;
...
export const Basic: Story = {
	render: function Render(args) {
		const [, updateArgs] = useArgs<React.ComponentProps<typeof DeprecatedMultiSelect>>();
