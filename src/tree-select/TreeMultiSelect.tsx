...
import { formatMultiSelectOptionCount } from "../multi-select/lib/formatMultiSelectOptionCount";
...
function formatTreeMultiSummary(selectedIds: Set<string>, treeIndex: ReturnType<typeof createTreeNodeIndex>) {
	...
	return formatMultiSelectOptionCount(selectedPredicateCount);
}
...
export function TreeMultiSelect({
	...
	return (
		<TreePickerBase
			...
			onQuery={onQuery}
			onNodeActivate={(node, selectionScopeIndex) => {
				setDraftValue(toggleTreeMultiSelection({}, node.id, treeIndex, selectionScopeIndex));
			}}
			onNodeToggleSelection={(node, selectionScopeIndex) => {
				setDraftValue((currentDraftValue) => toggleTreeMultiSelection(currentDraftValue, node.id, treeIndex, selectionScopeIndex));
			}}
